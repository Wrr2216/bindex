...
# T21: ffmpeg samples frames from walkthrough videos and pdftoppm (poppler)
# renders PDF manifests to page images. Both are optional at runtime; without
# them bulk capture takes photos and images only.
